...
play_again_bot_loses = [
    ...
    "Я наверно сегодня не с той ноги встал. Повторим?",
    "Кажется, алгоритмы надо подкрутить. Сыграем снова?",
...
def define_winner(bot_choice: str, user_choice: str) -> tuple[str, str]:
    if bot_choice == "🪨" and user_choice == "✂️":
        ...
        game_result = "Кажется, я проиграл..."
